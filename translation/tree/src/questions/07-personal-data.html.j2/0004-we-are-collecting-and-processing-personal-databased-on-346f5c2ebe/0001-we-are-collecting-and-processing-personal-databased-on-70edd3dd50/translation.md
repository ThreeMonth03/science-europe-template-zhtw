...
```text
We are collecting and processing personal data based on subject's consent.
```

### Translation (zh_Hant)

~~~jinja
我們基於資料主體的同意蒐集與處理個人資料。
~~~
...
- Unit Key: `we-are-collecting-and-processing-personal-databased-on-70edd3dd50`
