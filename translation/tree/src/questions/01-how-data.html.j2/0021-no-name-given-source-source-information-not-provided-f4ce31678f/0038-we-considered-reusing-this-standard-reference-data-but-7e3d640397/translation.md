...
~~~jinja
我們曾考慮再次使用此標準參考資料，但決定不再次使用，因為其使用條件不允許我們使用。
~~~
...
- Unit Key: `we-considered-reusing-this-standard-reference-data-but-7e3d640397`
- Source Hash: `c0bad59f3db2796989049d3e177c4232ad8120d3`
