...
```text
Its conditions of use do not permit the intended re-use.
```

### Translation (zh_Hant)

~~~jinja
此資料集的使用條件不允許本計畫規劃的再次使用方式。
~~~
...
- Unit Key: `its-conditions-of-use-do-not-permit-the-4e86625ae2`
- Source Hash: `585fe72160fb38c896975f703480585b1f7454b2`
