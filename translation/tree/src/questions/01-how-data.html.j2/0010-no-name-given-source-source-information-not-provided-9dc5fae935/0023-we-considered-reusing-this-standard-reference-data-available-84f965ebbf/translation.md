...
~~~jinja
我們曾考慮再次使用可透過 {refDataWhere} 取得的此標準參考資料，但決定不再次使用，因為其中缺少必要面向。
~~~
...
- Unit Key: `we-considered-reusing-this-standard-reference-data-available-84f965ebbf`
- Source Hash: `d18a873e1f5bcf74ae865f272f737dc9eba6c3a0`
