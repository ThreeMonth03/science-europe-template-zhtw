...
~~~jinja
我們曾考慮再次使用可透過 {refDataWhere} 取得的此標準參考資料，但決定不再次使用，因為其品質不足。
~~~
...
- Unit Key: `we-considered-reusing-this-standard-reference-data-available-d37ab1dc25`
- Source Hash: `2df073128969003d621cabed03df3b1f2597ed53`
