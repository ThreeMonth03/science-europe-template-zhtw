...
~~~jinja
我們曾考慮再次使用可透過 {refDataWhere} 取得的此標準參考資料，但決定不再次使用，原因如下：{refDataUseNoOtherReasonReply}
~~~
...
- Unit Key: `we-considered-reusing-this-standard-reference-data-available-ac69f325fe`
- Source Hash: `498be3cb1569daf467ae2f8f410f5d85b3fccec2`
