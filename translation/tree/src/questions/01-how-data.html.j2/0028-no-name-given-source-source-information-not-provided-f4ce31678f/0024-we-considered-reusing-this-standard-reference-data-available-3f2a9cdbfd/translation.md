...
~~~jinja
我們曾考慮再次使用可透過 {refDataWhere} 取得的此標準參考資料，但決定不再次使用，因為其使用條件不允許我們使用。
~~~
...
- Unit Key: `we-considered-reusing-this-standard-reference-data-available-3f2a9cdbfd`
- Source Hash: `8c2a9da13f31a7e948518b2ff28daa1fbd4b204c`
