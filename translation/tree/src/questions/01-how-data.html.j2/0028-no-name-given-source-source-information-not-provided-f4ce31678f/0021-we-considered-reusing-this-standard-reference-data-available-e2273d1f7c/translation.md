...
~~~jinja
我們曾考慮再次使用可透過 {refDataWhere} 取得的此標準參考資料，但決定不再次使用，因為其中缺少我們需要的資料。
~~~
...
- Unit Key: `we-considered-reusing-this-standard-reference-data-available-e2273d1f7c`
- Source Hash: `d2d68c9d59b9493b7347fb72ec5cf4bee7700b56`
