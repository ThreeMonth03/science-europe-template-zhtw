...
目前 0.3.5 的英中工作分支為 `feat/reading-polish`，承接 0.3.4 的 `feat/format-volume-reading`。
...
本輪 Q2／Q3／Q10 的固定敘述結構與 Q1 的短表格提示屬於英文來源的客製修改，
不是直接修生成後的中文 Jinja。Q2 已加入 `.upstream/base.json` 的 critical
重疊清單；Q1、Q3、Q10、共用 macro 原已在清單中。未來升級須同時重跑缺答、
