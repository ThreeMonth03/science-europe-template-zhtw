...
不同版本或不同案例冒充基準。四組均保留 HTML、PDF、DOCX、fixture 校驗碼與
Word 預覽，以便重查。沒有登入或更動線上 DSW。
...
- 原生 Word 從第一題起逐段核對文字、樣式、keep 屬性。只允許新版固定敘述
  對應的完整相鄰舊段落合併，其餘段落與所有表格內容／段落样式必須不變。
...
導覽／封存提交與套件來源分開記錄；乾淨重建须產生相同 ZIP。封存工具拒絕
