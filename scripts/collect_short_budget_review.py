...
def main():
    ...
    for name in ['rejection.json', 'manifest.json', 'missing-info-render-report.json', 'owned-test-template-cleanup.json']:
    ...
    for name in ['short-budget-report.json', 'manifest.json', 'missing-info-render-report.json', 'owned-test-template-cleanup.json', 'runtime-restoration.json']:
