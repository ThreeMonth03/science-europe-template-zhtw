...
def main():
    ...
    final = read(a.final, 'missing-info-report.json')
    ...
    for label, build, report, expected in [('initial',a.initial,initial,66),('final',a.final,final,18)]:
        ...
        filename = 'missing-info-complete-initial-report.json' if label == 'initial' else 'missing-info-report.json'
    ...
    for filename in ['README.md','missing-info-report.json','fixture-validation.json','extra-fixture-validation.json','checksums.json']:
