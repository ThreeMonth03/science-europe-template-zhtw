...
def main():
    ...
    for name in ['archive-gap-scope.json', 'archive-gap-engine-english.json', 'archive-gap-engine-chinese.json']:
    ...
    for name in ['probe_archive_gap_panels.py', 'generate_archive_gap_fixtures.py']: copy(a.english/'scripts'/name, 'reproduce/'+name)
