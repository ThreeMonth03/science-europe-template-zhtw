...
TABLE_CASES = {"populated", "partial", "stress", "representative", "retention-partial", "structured", "structured-partial", "storage-sharing", "storage-sharing-partial", "narrative-long"}
