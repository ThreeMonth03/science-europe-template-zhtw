...
def main():
    ...
    for name in ['metadata-followup-report.json','worker-start.json','worker-lifecycle.json','runtime-restoration.json']:
    ...
    for name in sorted(set(report['helper_sha256'])|{'check_metadata_followup_outputs.py','collect_metadata_followup_review.py','probe_metadata_followup_scope.py','capture_metadata_pages.py'}):
