...
def pair(before, after, case, language, profile, partial_projection, compacted=False, submission_compare=None):
    ...
    if profile == 'review':
        ...
        (submission_compare or compare)(expected_partial, candidate, language)
