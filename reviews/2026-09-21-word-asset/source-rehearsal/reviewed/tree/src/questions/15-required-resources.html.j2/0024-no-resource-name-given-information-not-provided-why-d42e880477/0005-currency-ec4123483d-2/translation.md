...
```text
Currency: {projectCostItemCurrencyReply}.
```

### Translation (zh_Hant)

~~~jinja
幣別：{projectCostItemCurrencyReply}
~~~
...
- Wrapper Order: `24`
- Wrapper Key: `no-resource-name-given-information-not-provided-why-d42e880477`
- Unit Key: `currency-ec4123483d-2`
- Source Hash: `4324bab2e18c4f4ea60feaa53c86447582aaf3c1`
