...
def run(english, tooling, output):
    ...
    proof = dict(prototype_only=True, source_integrated=False, english_commit=ENGLISH_COMMIT, tooling_commit=TOOL_COMMIT,
        ...
        before_metadata=original, after_metadata=metadata,
...
if __name__ == '__main__':
    ...
    a = p.parse_args(); print(json.dumps(run(a.english.resolve(), a.tooling.resolve(), a.output.resolve()), ensure_ascii=False))
