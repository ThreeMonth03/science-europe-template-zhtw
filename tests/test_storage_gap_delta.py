...
from probe_personal_data_translation import archived_pairs, verify_latest_translation_chain, verify_metadata_translation_chain
...
class StorageGapDeltaTests(unittest.TestCase):
    def test_current_tree_exact_reviewed_chain(self):
        ...
        personal, following = verify_metadata_translation_chain(values)
